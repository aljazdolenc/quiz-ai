...
import {type ButtonHTMLAttributes, type FC, type HTMLAttributes, type ReactNode, useRef, useState} from "react";
...
const ExpandableChatBody: FC<HTMLAttributes<HTMLDivElement>> = ({
    ...
    className={cn("flex-grow overflow-y-auto", className)} {...props} />;
...
const ExpandableChatFooter: FC<HTMLAttributes<HTMLDivElement>> = ({
    ...
    className={cn("border-t p-4", className)} {...props} />;
