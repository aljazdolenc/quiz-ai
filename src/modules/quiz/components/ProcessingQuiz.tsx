...
export function ProcessingQuiz() {
  ...
  return (
    <div
      className="flex-1 min-h-0 flex flex-col justify-center items-center gap-6">
      <div
        className="flex flex-col items-center justify-center gap-6 px-4 pt-6 sm:pt-12">
        <h1
      ...
      <div className="w-full max-w-md space-y-3 animate-fade-in">
        ...
        {progress > 90 && (
          <div
            className="p-4 border rounded-lg bg-white shadow-sm border-blue-500">
            <div className="flex items-center">
              <IconLoader
                className={`w-5.5 h-5.5 mr-2 text-blue-500 animate-spin`}/>
