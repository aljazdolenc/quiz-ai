...
export function QuizQuestion({question, setIsAnswered, previewMode}: Props) {
    if (question.type === QuestionTypeDto.TEXT) {
        return <TextQuestion question={question} answeredChanged={setIsAnswered} previewMode={previewMode}/>
    }

    if (question.type === QuestionTypeDto.SELECT) {
        return <SelectQuestion question={question} answeredChanged={setIsAnswered} previewMode={previewMode}/>
    }
